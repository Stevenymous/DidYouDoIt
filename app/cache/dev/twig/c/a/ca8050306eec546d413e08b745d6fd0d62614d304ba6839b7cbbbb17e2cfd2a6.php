...
\t\t\t    <td><a class=\"btn btn-warning\" role=\"button\"  href=\"";
            // line 16
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("did_you_do_it_edit_task_from_tasklist", array("idTaskList" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "tasklistid", array()), "idTask" => $this->getAttribute($context["task"], "taskid", array()))), "html", null, true);
            echo "\">
\t\t\t\t    Edit task 
\t\t\t        </a>
                </td>
...
\t\t<a class=\"btn btn-success\" role=\"button\" href=\"";
        // line 25
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("did_you_do_it_new_task", array("idTaskList" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "tasklistid", array()))), "html", null, true);
        echo "\">
\t\t\tAdd new Task
\t\t</a>
\t\t</li>
...
\t\t\t<a class=\"btn btn-warning\" role=\"button\" href=\"";
        // line 30
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("did_you_do_it_edit_tasklist", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "tasklistid", array()))), "html", null, true);
        echo "\">
\t\t\t\tEdit
\t\t\t</a>
\t\t</li>
